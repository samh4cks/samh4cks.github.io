...
header:
    ...
    caption: "[__HackTheBox__](https://www.hackthebox.com/achievement/machine/337503/1)"
related: true
tags: ["lame","command injection", "linux"]
---

This writeup is based on [__Lame__](https://app.hackthebox.com/machines/Lame/activity) on Hack the box.

# TL;DR

This writeup is based on [__Lame__](https://app.hackthebox.com/machines/Lame/activity) on Hack the box. It was a Linux box. It starts with two
